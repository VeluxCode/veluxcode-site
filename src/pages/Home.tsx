...
const Home = () => {
  ...
  return (
    <div className="bg-background text-primary min-h-screen pt-20">
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16 animate-fadeIn">
          <div className="w-full max-w-4xl mx-auto mb-8">
            <h1 className="text-9xl font-bayon tracking-tighter">
              <span className="text-primary animate-slideInLeft">VELUX</span>
              <span className="text-blue-500 animate-slideInRight">CODE</span>
            </h1>
          </div>
          <p className="text-xl mb-10 text-gray-600 animate-fadeIn animation-delay-300">{t.illuminatingDigitalSolutions}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {[
            ...
            <div key={index} className={`bg-white p-6 rounded-lg shadow-lg transform hover:scale-105 transition-all duration-300 animate-fadeInUp animation-delay-${(index + 1) * 150}`}>
              <service.icon size={48} className="text-blue-500 mb-4" />
              <h2 className="text-2xl font-bayon mb-2">{service.title}</h2>
